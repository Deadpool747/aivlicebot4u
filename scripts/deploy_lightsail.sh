...
LOCAL_SARVAM_API_KEY="$(awk -F= '$1=="SARVAM_API_KEY"{print substr($0, index($0, "=")+1); exit}' "$ROOT_DIR/.env")"
LOCAL_PIOPIY_SARVAM_API_KEY="$(awk -F= '$1=="PIOPIY_SARVAM_API_KEY"{print substr($0, index($0, "=")+1); exit}' "$ROOT_DIR/.env")"
