...
function createAuth(directory,{cookiePath='/',secure=false,cookieName='voice_session'}={}){
const cookieFlags=`HttpOnly; SameSite=Strict; Path=${cookiePath};${secure?' Secure;':''}`;
